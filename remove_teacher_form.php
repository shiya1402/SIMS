...
<div class="form-container">
    <form action="" method="POST">
        <label for="teachername">Teacher Username:</label>
    ...
    <?php
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") 
        {
            ...
            $sql = "SELECT * FROM user WHERE username='".$teachername."' ";
            ...
            if($res)
            {
                if(mysqli_num_rows($res)>0)
                {
                    ...
                    {
                            $sql1 = "DELETE FROM user WHERE username='".$teachername."' ";
                    ...
                    {
                        echo "<p style='color: red'> No Teacher by this username exists !! </p>";
                    }
                }
                else
                {
