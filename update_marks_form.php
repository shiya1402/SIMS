<?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            $sql = "UPDATE `marks` SET `Data Structures` ='$dsa', `Web Development`='$wd', `Software Engg.`='$se', `Data Science`='$ds', `DevOps`='$dev' WHERE `username`='$id' ";
            $result=mysqli_query($conn,$sql);
            if($result)
            {
...
document.getElementById('logoutButton').addEventListener('click', function() {
    ...
    window.location.href = 'update_marks.php'; // Change '/logout' to your actual logout URL or login page
});
</script>
</body>
</html>