...
<div class="container">
    <div class="left-panel">
        <ul>
            ...
            <li><a href="add_teacher_form.php">Add Teacher</a></li> 
            <li><a href="view_student_form.php">View Student</a></li>
            <li><a href="view_teacher_form.php">View Teacher</a></li>
            <li><a href="remove_student_form.php">Remove Student</a></li> 
